...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Example.RestApi*):
...
Execute unit tests
```
    cd "Example.RestApi/test/Example.RestApi.Tests"
    dotnet test
```

Deploy application
```
    cd "Example.RestApi/src/Example.RestApi"
